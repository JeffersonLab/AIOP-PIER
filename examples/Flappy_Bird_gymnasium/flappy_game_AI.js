...
class FlappyGame {
    ...
    async loadModel() {
        try {
            ...
            this.ort_session_policy = await ort.InferenceSession.create("flappy_bird_rl_policy_model.onnx");
            this.ort_session_action = await ort.InferenceSession.create("flappy_bird_rl_action_model.onnx");
